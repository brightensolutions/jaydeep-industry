    ...
    <div className="bg-white">
      ...
      <section className="py-10 md:py-16 bg-[#fafafa]">
        <div className="max-w-[1600px] mx-auto px-0 md:px-8">
          <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-10 md:mb-16 border-l-8 border-[#da222a] ml-6 md:ml-0 pl-6 md:pl-8">
            <div>
              <p className="text-[10px] md:text-xs font-black uppercase tracking-[0.4em] text-gray-400 mb-2">Government Recognition</p>
              <h3 className="text-3xl md:text-6xl font-black uppercase text-gray-900 mb-4">DGFT Export House</h3>
              <p className="text-gray-500 text-sm md:text-base leading-relaxed max-w-3xl border-l-[3px] border-gray-200 pl-4 py-1 italic font-medium">
                "Recognised by DGFT (Director General of Foreign Trade, Government of India, Ministry of Commerce and Industry) as a One Star Export House."
              </p>
            </div>
            <Award className="text-gray-200 w-12 h-12 md:w-16 md:h-16 hidden md:block" />
          </div>
