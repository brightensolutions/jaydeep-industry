...
const products = [
  {
    ...
    description: "High-precision bearings for heavy machinery and critical applications.",
  ...
  },
  {
    ...
    description: "Efficient solutions for air and liquid purification in industrial settings.",
    image: "/placeholder.svg?height=400&width=600",
  ...
  return (
    <section className="py-16 md:py-24 bg-[#da222a]/5">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        >
          <h2 className="text-4xl font-extrabold text-[#da222a] mb-4">Our Featured Products</h2>
          <p className="text-lg text-gray-700 max-w-2xl mx-auto">
            Discover our range of high-quality industrial products, engineered for performance and durability.
          </p>
        </motion.div>
