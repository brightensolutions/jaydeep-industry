      ...
      >
        <nav className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center py-4">
            ...
            {/* 50TH ANNIVERSARY BADGE - CENTERED */}
            <motion.div
              initial={{ opacity: 0, y: -20 }}
              animate={{ opacity: 1, y: 0 }}
              transition={{ delay: 0.5, duration: 0.6 }}
              className="hidden lg:flex flex-col items-center justify-center absolute left-1/2 transform -translate-x-1/2"
            >
              <div className="text-center">
                <span className="block text-[#da222a] font-black text-xs tracking-[0.3em] mb-1">
                  50 YEARS OF PRECISION
                </span>
                <div className="flex items-center gap-3">
                  <span className="text-gray-600 text-sm font-medium">1976</span>
                  <div className="w-12 h-[2px] bg-[#da222a]"></div>
                  <span className="text-gray-600 text-sm font-medium">2026</span>
                </div>
                ...
                <div className="mt-2">
                  <Link 
                    href="/timeline" 
                    className="text-xs text-[#da222a] font-semibold hover:underline inline-flex items-center gap-1"
                  >
          ...
          {/* Mobile 50th Anniversary Badge (simplified for mobile) */}
          <div className="lg:hidden flex justify-center my-2 py-2 border-y border-red-100">
            <div className="text-center">
              <span className="block text-[#da222a] font-bold text-xs tracking-wider">
                50 YEARS OF PRECISION
              </span>
              <div className="flex items-center gap-2 justify-center mt-1">
                <span className="text-gray-600 text-xs">1976</span>
                <div className="w-8 h-[2px] bg-[#da222a]"></div>
